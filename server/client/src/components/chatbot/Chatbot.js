...
export class Chatbot extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <Card title={<div><img alt = '' src='/logo-light.jpg' style={{width: '60px'}} /><span style={styles.chatBoxTitle}>Assistant</span></div>} extra={<HeartFilled style={styles.icon} />}
                    style={styles.chatBox}
                    actions={[
                        <Search style= {styles.messageSend} allowClear 
                        placeholder="Leave your message..." 
                        onSearch={value => this.handleSend(value)} enterButton={<SendOutlined />} 
